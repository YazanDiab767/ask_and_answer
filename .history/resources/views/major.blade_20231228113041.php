						...
						<div class="row justify-content-center" id="page-contents">
							<div class="col-lg-11 " >
								<div class="central-meta text-center header_course" style="padding-bottom: 90px">
                                    ...
                                    <h1 class="text-black" style="font-size: 50px; margin-top: -110px;"><u><i class="fa-solid fa-book-open mr-2"></i>{{ $major->name }}</u></h1>
								</div>
							</div>
                                            ...
                                            <div class="col-sm-3">
                                                <aside class="sidebar static w-100">
                                                    <div class="widget" > {{--style="background-color: #088dcd; color: white;"--}}
                                                        ...
                                                        <ul class="naves">
                                                            <li>
                                                                <b><i class="fa-solid fa-book"></i> Major : {{ $course->name }} </b>
                                                            </li>
                                                            <li>
