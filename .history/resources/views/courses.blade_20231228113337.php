						...
						<div class="row justify-content-center" id="page-contents">
							<div class="col-lg-11">
								<div class="central-meta text-center">
                                    ...
                                    <div class="text-left mt-3"> <a href="#" class="btn btn-primary" data-target=".majors" data-toggle="modal" > <i class="fa-solid fa-table"></i> Show Majors </a> </div>
...
<div class="modal fade majors" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content p-3" style="margin-top: 60px;">
        <h2> <i class="fa-solid fa-table-cells"></i> Majors </h2>
        <hr style="border-bottom: 1px solid black; color: black;">
        <div class="text-center w-100">
            @foreach ($college->majors as $major)
            <a href="/major/{{ $major->id }}">
                <div class="mt-5 p-3" style="box-shadow: -2px 1px 11px 0px rgba(0,0,0,0.75);">
                    <b>{{ $major->name }}</b><br/>
                    <small> {{ $major->created_at }} </small>
                </div>
            </a>
            @endforeach
        </div>
