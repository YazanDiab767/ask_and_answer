...
<div class="modal showMajors" id="showMajors" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"> <i class="fa-solid fa-subscript"></i> Majors <b class="titleDiv"></b> </h5>
                {{-- <div class="float-left">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                ...
                <div>
                    <button class="btn btn-success btnAddNewResource text-white" data-toggle="modal" data-target="#newResource"> + Add New Major </button>
                </div>
            </div>
            <div class="modal-body">
                <div class="table-responsive mt-5">
