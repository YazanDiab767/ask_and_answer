    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="input-group">
                ...
                <input type="text" class="form-control" id="searchInputMajor" placeholder="Please enter major name" aria-label="Username" aria-describedby="basic-addon1">
            </div>
            <div class="modal-body">
                <div class="table-responsive mt-3">
                    <table class="table table-striped text-center table_majors" id="cs">
                        <thead>
                            <tr>
                                <th>  </th>
                                <th> <b> Name </b> </th>
