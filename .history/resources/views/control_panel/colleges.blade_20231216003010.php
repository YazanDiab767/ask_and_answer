                                                ...
                                                <tbody id="colleges">
                                                    ...
                                                    @foreach ($colleges as $college)
                                                        <tr class="college">
                                                            ...
                                                            <td class="align-middle text-right" style="width: 20%;">
                                                                <a href="{{$college->id}}/{{$college->name}}/{{ $c++ }}" class="btn btn-info btnEditCollege w-50" data-toggle="modal" data-target=".editCollege" > <i class="fa-solid fa-subscript"></i> Majors  </a>
                                                            </td>
