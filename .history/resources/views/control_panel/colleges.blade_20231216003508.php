                                                    ...
                                                    @foreach ($colleges as $college)
                                                        <tr class="college">
                                                            ...
                                                            <td class="align-middle text-center" style="width: 12%;">
                                                                <a href="{{$college->id}}/{{$college->name}}/{{ $c++ }}" class="btn btn-info btnShowMajors w-100" data-toggle="modal" data-target=".showMajors" > <i class="fa-solid fa-subscript"></i> Majors  </a>
                                                            </td>
...
<div class="modal showMajors" id="showMajors" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"> <i class="fa-solid fa-subscript"></i> Majors </h5>
                <div class="float-left">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
