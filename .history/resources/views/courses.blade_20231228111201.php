						...
						<div class="row justify-content-center" id="page-contents">
							<div class="col-lg-11">
								<div class="central-meta text-center">
                                    ...
                                    <div class="text-left mt-3"> <a href="#" onclick="history.back()" class="btn btn-success"> <i class="fa-solid fa-circle-left"></i> Back </a> </div>
                                    <h2 class="text-black" style="font-size: 28px;">  <u> {{ $college->name }} </u> </h2>
                                    {{-- <img src="/storage/{{ $college->image }}" class="title_image" /> --}}
                                    <div class="text-left">
                                        <label class="text-info mt-1">-Number of courses : <b> {{ count( $college->courses ) }} </b></label>
                                    </div>
