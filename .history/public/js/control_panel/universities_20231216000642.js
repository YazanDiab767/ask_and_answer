$(document).ready(function () {
    ...
    $("body").on('submit', '.formApproveUniversity', function (e) {
        e.preventDefault();
        let t = $(this);
        let data = new FormData(this);
        if (confirm("Are you sure you want to approve this university ?")) {
            $.ajax({
                type: 'POST',
                url: t.attr('action'),
                data: data,
                ...
                error: function (data) {
                    alert("There is a problem in approve this University, please try again ");
                },
                contentType: false,
                cache: false,
                processData: false
