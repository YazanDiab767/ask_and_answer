            ...
            for (const item of data) {
                $("#majors").append(`
                    <tr>
                        ...
                        <td> ${item.name} </td>
                        <td style="width: 40%">
                            <form action="${host}control_panel/college/deleteMajor/${item.id}" class="formDeleteCourse" method="POST">
                                <input type="hidden" name="_token" value="${token}">
                                <input type="hidden" name="_method" value="DELETE">
            ...
            success: function (data) {
                $("#majors").append(`
                    <tr>
                        <td> ${data[0].name} </td>
                        <td>
                            <form action="${host}control_panel/courses/deleteMajor/${data[0].id}" class="formDeleteMajor" method="POST">
                                <input type="hidden" name="_token" value="${token}">
                                <input type="hidden" name="_method" value="DELETE">
