...
class UsersController extends Controller
{
    ...
    public function getOffers()
    {
        ...
        $file = "programmer_offers.txt";

        $user_major = auth()->user()->major;

        if ( $user_major == "Computer Engineering" || $user_major == "computer science" || strpos($user_major, "computer") !== false  )
            $file = "programmer_offers.txt";
        else if ( $user_major == "Electricity Engineering" || $user_major == "Electricity" || strpos($user_major, "electricity") !== false )
            $file = "electricity_offers.txt";
        else if ( $user_major == "nursing" || $user_major == "Pharmacy" || strpos($user_major, "nursing") !== false )
            $file = "nursing_offers.txt";

        $jsonData = file_get_contents(asset($file));
    ...
    public function update(Request $request , $type) //update data of user
    {
        ...
        {
            $university = \App\Models\University::where('name', $request["university"])->first();
            $university_id;
