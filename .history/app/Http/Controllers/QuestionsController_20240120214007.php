...
class QuestionsController extends Controller
{
    ...
    public function showLastQuestions()
    {
        ...
        $questions = Question::whereIn('course_id' , explode(',' , auth()->user()->courses))
                    ...
                    ->orderBy('id','DESC')
                    ->with('user')->with('comments')->with('likes')->with('course.college')->with('major.college')
    ...
    {
        return Question::where('user_id',$user->id)->with('user')->with('comments')->with('likes')->with('course')->with('major.college')->paginate( Question::$paginate );
    }

    public function course($course)
    {
        return Question::where('course_id',$course)->with('user')->with('comments')->with('likes')->orderBy('created_at','DESC')->paginate( Question::$paginate );
    } 

    public function major($major)
    {
        return Question::where('major_id',$major)->with('user')->with('comments')->with('likes')->with('major.college')->orderBy('created_at','DESC')->paginate( Question::$paginate );
    } 
    ...
    {
        return Question::where('id',$question->id)->with('user')->with('comments')->with('likes')->with('course.college')->first();
    }
    ...
    public function getSavedQuestion(User $user)
    {
        $questions = Question::where('user_id' , $user->id)
                    ->orderBy('id','DESC')
                    ->with('user')->with('comments')->with('likes')->with('course.college')->with('major.college')
    ...
    public function getSavedQuestions()
    {
        ...
        {
            $saveQuestions = explode(',', $user->savedQuestions);
            return Question::whereIn('id',$saveQuestions)->with('user')->with('comments')->with('major.college')->with('likes')->with('course.college')->paginate( Question::$paginate );
        }
