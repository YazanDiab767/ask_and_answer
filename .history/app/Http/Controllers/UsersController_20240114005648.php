...
class UsersController extends Controller
{
    ...
    public function getOffers()
    {
        ...
        $response = $client->request('GET', 'https://rapid-linkedin-jobs-api.p.rapidapi.com/search-jobs?keywords=electricity&locationId=92000000&datePosted=anyTime&sort=mostRelevant', [
            'headers' => [
