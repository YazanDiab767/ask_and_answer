...
class QuestionsController extends Controller
{
    ...
    {
        return Question::where('major_id',$major)->with('user')->with('comments')->with('likes')->orderBy('created_at','DESC')->paginate( Question::$paginate );
    } 
    ...
    public function getQuestionsForUser(User $user)
    {
        $questions = Question::where('user_id' , $user->id)
                    ->orderBy('id','DESC')
                    ->with('user')->with('comments')->with('likes')->with('course.college')
                    ->paginate(Question::$paginate);
